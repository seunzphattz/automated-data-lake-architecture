...
users = spark.read.csv("s3://aws-de-projects-bucket/rental_vehicles/users.csv", header=True, inferSchema=True)
...
# Write results to S3
transaction_metrics.write.parquet("s3://aws-de-projects-bucket/rental_vehicles/output/transaction_metrics", mode="overwrite")
user_metrics.write.parquet("s3://aws-de-projects-bucket/rental_vehicles/output/user_metrics", mode="overwrite")
